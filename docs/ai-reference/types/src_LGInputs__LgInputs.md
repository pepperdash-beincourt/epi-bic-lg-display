...
| Language | C# |
| Declaration | `class LgInputs` with declared base/contract list `ISelectableItems<string>` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Plugins.Lg.Display` |

## What

`LgInputs` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
