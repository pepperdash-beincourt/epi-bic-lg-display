...
| Language | C# |
| Declaration | `class LgDisplayIrInput` with declared base/contract list `ISelectableItem` |
| Accessibility | `public` |
| Namespace/module | `PepperDash.Essentials.Plugins.Lg.Display` |

## What

`LgDisplayIrInput` is a source-level implementation type with responsibilities defined by its members and inheritance. This description is grounded in its source declaration and declared inheritance rather than inferred product behavior.
